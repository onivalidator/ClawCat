...
class ClawCatBot:
    """Telegram bot for remote Codex control."""
    ...
    COMMANDS = {
        ...
        "newsession": "Start a new Codex session",
    ...
    async def handle_message(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        """Handle regular text messages as Codex instructions."""
        if not await self._check_auth(update):
            return
    ...
    async def _send_result(self, update: Update, result) -> None:
        ...
        Args:
            update: Telegram update.
            result: RunResult from Codex execution.
        """
