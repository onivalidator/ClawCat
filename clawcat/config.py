...
def load_config(config_path: Optional[Path] = None) -> Config:
    ...
    default_executable = r"C:\Users\kevin\.local\bin\claude.exe"
    executable = claude_raw.get("executable", default_executable)

    # Default working directory
    default_working_dir = r"C:\Users\kevin"
    working_dir = claude_raw.get("working_dir", default_working_dir)
